...
if __name__ == "__main__":
    ...
    embedding_dim = 250
    train_data_file = "../data/input_model_1/org_train_without_duplicates.csv"
    train_data_dup_file = "../data/input_model_1/org_train_with_duplicates.csv"
    test_data_file = "../data/input_model_1/org_test_without_duplicates.csv"
    ...
    save_to_directory = "../data/input_model_1/models"
